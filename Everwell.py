...
#mydb=pymysql.connect(host='192.168.45.19',port=int(3306),user='Nagula_s',passwd='Nagula@2021$$',db='bihar_db_iemr')
host = "192.168.45.19"
user = "Nagula_s"
password = "Nagula@2021$$" 

connection_string = "mysql+pymysql://"+user+':'+password+'@'+host+':3306/'
...
def main():
    ...
    start_date = st.date_input('Start date',start_of_week )
